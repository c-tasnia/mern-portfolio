...
export default function Education() {
  return (
    <section id="education" className="py-24 px-5 sm:px-8 bg-ink-soft/40">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-baseline gap-3 mb-12">
          <span className="gutter-line">02</span>
          <h2 className="section-heading text-3xl font-semibold text-fg-primary">Education</h2>
        </div>
            ...
            >
              ...
              <div className="flex flex-wrap items-baseline justify-between gap-2 mb-1">
                <h3 className="section-heading text-lg font-semibold text-fg-primary">
                  {job.university} <span className="text-fg-muted font-normal">· {job.subject}</span>
                </h3>
